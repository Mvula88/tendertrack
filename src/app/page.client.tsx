        ...
        <section id="features" className="py-32 bg-slate-50 dark:bg-slate-900/30">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[250px] md:auto-rows-[300px]">
              {/* Feature 1: Main */}
              <div className="md:col-span-8 md:row-span-2 group relative overflow-hidden rounded-3xl border border-slate-200 dark:border-slate-800 p-8 md:p-12 hover:border-primary/50 transition-colors">
                {/* Background Image */}
                <div 
                  className="absolute inset-0 bg-cover bg-center"
                  style={{
                    backgroundImage: 'url(/tender-discovery-bg.jpg)',
                  }}
                />
                
                {/* Dark Overlay for Text Readability */}
                <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-slate-900/70 to-slate-900/60 dark:from-slate-950/90 dark:via-slate-950/80 dark:to-slate-950/70" />

                <div className="relative z-10 h-full flex flex-col">
                  <div className="w-14 h-14 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-blue-500/20">
                    <Search className="h-7 w-7 text-primary" />
                  </div>
                  <h3 className="text-3xl font-bold mb-4 text-white drop-shadow-lg">Intelligent Tender Discovery</h3>
                  <p className="text-lg text-slate-100 dark:text-slate-200 leading-relaxed max-w-md font-medium drop-shadow-md">
                  ...
                  <div className="mt-auto pt-8">
                     <div className="flex gap-3">
                        <div className="px-4 py-2 rounded-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-200 shadow-md">Government</div>
                        <div className="px-4 py-2 rounded-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-200 shadow-md">Parastatals</div>
                        <div className="px-4 py-2 rounded-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-200 shadow-md">Private</div>
                     </div>
                  </div>
                </div>
              </div>
